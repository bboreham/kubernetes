...
/opt/cni/bin/weave-net:
  file.managed:
    - source: https://github.com/weaveworks/weave/releases/download/v1.6.0/weave-cni-plugin
...
/etc/kubernetes/manifests/weave-launch.manifest:
  file.managed:
    - source: salt://weave/weave-launch.manifest
    - template: jinja
    - group: root
    - dir_mode: 644
    - makedirs: True
